...
// Removed: std::string sanitizeNameForWindowList(const std::string& name) { ... }
// Removed: std::string buildWindowList() { ... }
// Removed: SSelectionData promptForScreencopySelection() { ... }
